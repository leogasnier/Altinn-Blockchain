...
export class CreateSampleParticipantTransaction extends CreateParticipantTransactionBuilder {
  public constructor() {
    super();
    this.transactionType = TransactionType.createSampleParticipant;
    this.participantType = ParticipantType.sampleParticipant;
  }
